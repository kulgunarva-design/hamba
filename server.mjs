...
const files = new Set(['index.html','about.html','services.html','contacts.html','booking.html','site.css','brand.css','booking.css','app.js','booking.js','contact-fix.js','sms-client.js','img/logo.jpg','img/laud-edited.png','clinic-photo.css','robots.txt','map.css','map.js','seo.css','sitemap.xml','favicon.svg']);
...
const types = {'.html':'text/html; charset=utf-8','.js':'text/javascript; charset=utf-8','.css':'text/css; charset=utf-8','.jpg':'image/jpeg','.png':'image/png','.txt':'text/plain','.xml':'application/xml; charset=utf-8','.svg':'image/svg+xml'};
let recent = [];
